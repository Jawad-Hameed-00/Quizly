...
import com.jawadhameed.quizly.data.local.QuizDatabase
import com.jawadhameed.quizly.data.remote.QuizRepository
import com.jawadhameed.quizly.databinding.ActivityQuizBinding
import com.jawadhameed.quizly.viewmodel.QuizViewModel
import com.jawadhameed.quizly.viewmodel.QuizViewModelFactory
...
class QuizActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val quizDao = QuizDatabase.getInstance(applicationContext).quizDao()
        ...
        quizViewModel.quizList.observe(this) {
            quizList = it
            setQuizData(index)
